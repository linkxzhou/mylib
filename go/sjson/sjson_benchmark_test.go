...
func BenchmarkDecoder_Generic_Sjson(b *testing.B) {
	var w interface{}
	m := []byte(TwitterJson)
	_ = Unmarshal(m, &w)
	b.SetBytes(int64(len(TwitterJson)))
...
func BenchmarkDecoder_Generic_Jsoniter(b *testing.B) {
	var w interface{}
	m := []byte(TwitterJson)
	_ = jsonfast.Unmarshal(m, &w)
	b.SetBytes(int64(len(TwitterJson)))
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		var v interface{}
		_ = jsonfast.Unmarshal(m, &v)
	}
}
...
func BenchmarkDecoder_Binding_Sjson(b *testing.B) {
	var w TwitterStruct
	m := []byte(TwitterJson)
	_ = Unmarshal(m, &w)
	b.SetBytes(int64(len(TwitterJson)))
...
func BenchmarkDecoder_Parallel_Generic_Sjson(b *testing.B) {
	var w interface{}
	m := []byte(TwitterJson)
	_ = Unmarshal(m, &w)
	b.SetBytes(int64(len(TwitterJson)))
...
func BenchmarkDecoder_Parallel_Binding_Sjson(b *testing.B) {
	var w TwitterStruct
	m := []byte(TwitterJson)
	_ = Unmarshal(m, &w)
	b.SetBytes(int64(len(TwitterJson)))
...
func BenchmarkEncoder_Generic_Sjson(b *testing.B) {
	_, _ = Marshal(_GenericValue)
	b.SetBytes(int64(len(TwitterJson)))
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, _ = Marshal(_GenericValue)
...
func BenchmarkEncoder_Generic_Jsoniter(b *testing.B) {
	_, _ = jsonfast.Marshal(_GenericValue)
	b.SetBytes(int64(len(TwitterJson)))
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, _ = jsonfast.Marshal(_GenericValue)
...
func BenchmarkEncoder_Binding_Sjson(b *testing.B) {
	_, _ = Marshal(&_BindingValue)
	b.SetBytes(int64(len(TwitterJson)))
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, _ = Marshal(&_BindingValue)
...
func BenchmarkEncoder_Binding_Jsoniter(b *testing.B) {
	_, _ = jsonfast.Marshal(&_BindingValue)
	b.SetBytes(int64(len(TwitterJson)))
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, _ = jsonfast.Marshal(&_BindingValue)
...
func BenchmarkEncoder_Parallel_Generic_Sjson(b *testing.B) {
	_, _ = Marshal(_GenericValue)
	b.SetBytes(int64(len(TwitterJson)))
	b.ResetTimer()
	b.RunParallel(func(pb *testing.PB) {
...
func BenchmarkEncoder_Parallel_Binding_Sjson(b *testing.B) {
	_, _ = Marshal(&_BindingValue)
	b.SetBytes(int64(len(TwitterJson)))
	b.ResetTimer()
	b.RunParallel(func(pb *testing.PB) {
